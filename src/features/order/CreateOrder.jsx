      ...
      <Form method="POST">
        ...
        <div className="mb-10 flex items-center gap-2">
          <input
            ...
            name="priority"
            id="priority"
            className="h-6 w-6 accent-teal-800 focus:outline-none focus:ring focus:ring-teal-800 focus:ring-offset-2"
            value={withPriority}
        ...
        <div>
          ...
          />
          <Buttons disabled={isSubmitting || isLoadingAddress} type="primary">
            {isSubmitting
              ? "Placing order..."
